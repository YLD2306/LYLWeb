...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE guest SET Reply = ?, RDate = ? WHERE ID = ?" 
    MM_editCmd.Prepared = true
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param1", 203, 1, 1073741823, Request.Form("Content")) ' adLongVarWChar
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param2", 135, 1, -1, MM_IIF(Request.Form("Rdate"), Request.Form("Rdate"), null)) ' adDBTimeStamp
...
<body>
  ...
  <table width="640"align="center" bgcolor="#CCCCCC"  cellpadding="5">
    <tr class="beijing">
      <td class="biaoti" align="center">回复留言</td>
    </tr>
    <tr>
    ...
    <tr>
     <td><form action="<%=MM_editAction%>" method="POST" name="form1" id="form1">
        <table align="center">
          <tr>
            <td nowrap="nowrap" align="right" valign="top">回复留言：</td>
            <td valign="baseline"><textarea name="Content" cols="50" rows="5"><%=((Recordset1.Fields.Item("Reply").Value))%></textarea></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input type="submit" value="确定回复" /></td>
          </tr>
        </table>
        <input name="Rdate" type="hidden" id="Rdate" value="<%=date%>" />
